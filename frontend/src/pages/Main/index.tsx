    ...
    <Container>
      ...
      <main>
        <IntroductionContent>
          ...
          <p>
            O portal da Computação Amostra reúne uma Amostra Digital dos projetos tecnológicos dos graduandos do 3º, 5º e 7º
            períodos do curso de <strong>Bacharelado em Ciência da Computação do CESUPA</strong>.
          </p>

          <p className="text">
          A COVID-19  impactou profundamente todos os setores da economia, e em especial o setor do varejo. Diversas empresas varejistas tiveram que repensar seus modelos de negócios e buscar por inovação.
          Em tempos difíceis, os desafios trazem oportunidades a todo instante. Entramos em uma nova década do séc.
          XXI vivenciando uma intensa transformação digital, a humanidade se uniu em uma revolução científica, disruptiva e de superação.
          É tempo de repensarmos a tecnologia para novos valores, nos reconectando como sociedade.
          </p>

          <p><b>É tempo de Reconectar!!!</b></p>
